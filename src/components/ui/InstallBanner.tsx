...
function IOSInstallGuide({ onDismiss }: { onDismiss: () => void }) {
  return (
    <div className="fixed bottom-[5.5rem] left-4 right-4 z-[var(--z-overlay)] max-w-[400px] mx-auto animate-slide-up">
      <div className="bg-surface-container-highest rounded-sm p-4 shadow-xl border border-outline-variant/10">
        <div className="flex items-start gap-3 mb-3">
          <div className="w-10 h-10 rounded-sm gold-gradient flex items-center justify-center flex-shrink-0 ambient-glow">
          ...
          <button
            onClick={onDismiss}
            className="w-8 h-8 rounded-full flex items-center justify-center text-secondary/40 hover:opacity-80 transition-transform flex-shrink-0"
            aria-label="Dismiss"
          >
            <span>✕</span>
          </button>
        ...
        <div className="space-y-2.5 mb-3">
          <div className="flex items-center gap-3 bg-surface-container rounded-sm px-3 py-2.5">
    ...
    <div className="fixed bottom-[5.5rem] left-4 right-4 z-[var(--z-overlay)] max-w-[400px] mx-auto animate-slide-up">
      <div className="bg-surface-container-highest rounded-sm p-4 shadow-xl border border-outline-variant/10">
        <div className="flex items-center gap-4">
          <div className="w-12 h-12 rounded-sm gold-gradient flex items-center justify-center flex-shrink-0 ambient-glow">
        ...
        <button
          ...
          className="w-full mt-3 py-3 gold-gradient rounded-sm text-[10px] font-bold uppercase tracking-widest text-on-primary hover:opacity-80 transition-all ambient-glow"
        >
          ADD TO HOME SCREEN
        </button>
      </div>
