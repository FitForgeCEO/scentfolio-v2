...
export function NotificationBell() {
  ...
  return (
    <>
      ...
      >
        <Icon name={unread > 0 ? 'notifications_active' : 'notifications'} className="text-primary" />
        {unread > 0 && (
...
function NotificationPanel({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div
      ...
      className="absolute top-14 right-2 w-[340px] max-h-[460px] bg-surface-container-low rounded-2xl shadow-2xl border border-surface-container-highest/20 z-[var(--z-dropdown)] overflow-hidden animate-scale-in"
    >
      {/* Header */}
      ...
      <div className="overflow-y-auto max-h-[380px] scrollbar-thin">
        {notifications.length === 0 ? (
          <div className="py-12 text-center">
            <Icon name="notifications_none" className="text-3xl text-secondary/20 mb-2 block mx-auto" />
